...
void display(){
 ...
 glColor3f(1.f, 0.f, 1.f); // Встановлення кольору об'єкта
 ...
 glVertex3f(-1.0f, -1.0f, 1.0f);
 // Права грань (x = 1.0f)
 glColor3f(1.0f, 0.0f, 1.0f); // Пурпуровий
 glVertex3f(1.0f, 1.0f, -1.0f);
 glVertex3f(1.0f, 1.0f, 1.0f);
 glVertex3f(1.0f, -1.0f, 1.0f);
 glVertex3f(1.0f, -1.0f, -1.0f);
...
// Головна функція: програма GLUT виконується як консольний застосунок
